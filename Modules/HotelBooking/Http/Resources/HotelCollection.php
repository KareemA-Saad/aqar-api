...
/**
 * Hotel Collection for paginated API responses.
 */
#[OA\Schema(
    schema: 'HotelCollection',
    title: 'Hotel Collection',
    description: 'Paginated collection of hotels',
    properties: [
        new OA\Property(property: 'data', type: 'array', items: new OA\Items(ref: '#/components/schemas/HotelResource')),
        new OA\Property(
            property: 'pagination',
            properties: [
