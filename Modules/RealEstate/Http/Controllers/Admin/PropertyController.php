...
class PropertyController extends BaseController
{
    ...
    #[OA\Get(
        ...
        parameters: [
            ...
            new OA\Parameter(name: 'filter[listing_type]', in: 'query', schema: new OA\Schema(type: 'string', enum: ['sale', 'rent'])),
            new OA\Parameter(name: 'filter[finishing]', in: 'query', schema: new OA\Schema(type: 'string', enum: ['finished', 'semi_finished', 'unfinished', 'furnished'])),
            new OA\Parameter(name: 'filter[is_featured]', in: 'query', schema: new OA\Schema(type: 'boolean')),
            new OA\Parameter(name: 'filter[is_published]', in: 'query', schema: new OA\Schema(type: 'boolean')),
            new OA\Parameter(name: 'filter[is_available]', in: 'query', schema: new OA\Schema(type: 'boolean')),
