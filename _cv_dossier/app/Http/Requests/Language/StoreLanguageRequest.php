...
/**
 * Store Language Request
 *
 * Validates data for creating a new language.
 */
#[OA\Schema(
    schema: 'StoreLanguageRequest',
    title: 'Store Language Request',
    description: 'Request body for creating a new language',
    required: ['name', 'slug'],
    properties: [
        new OA\Property(
            property: 'name',
...
final class StoreLanguageRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'slug.required' => 'Language code is required.',
    ...
    {
        $this->merge([
            'direction' => $this->input('direction', 0),
